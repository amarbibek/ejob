					...
					echo '<div class="job">';
						echo '<div class="job-main">';
							echo '<div class="grid-x">';
								...
								// if($row['pdf_url']!=NULL){
									// echo '<div class="cell large-1 medium-2 small-2 job-pdf text-right" ><a title="Download" href=  "'.$row["pdf_url"].'" target="_blank"><i class="fa fa-download"></i></a></div>';
							...
							echo '<div class="visit-site">';
								if($row['pdf_url']!=NULL){
									echo '<div class="cell large-1 medium-2 small-2 job-pdf" ><a title="Download PDF" href=  "'.$row["pdf_url"].'" target="_blank"><i class="fa fa-download"></i></a></div>';
								}
